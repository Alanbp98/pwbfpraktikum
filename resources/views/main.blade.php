  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html"><h2>Legal Literacy</h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="services.blade.php">Our Services</a>
              </li>                          
              <li class="nav-item">
                <a class="nav-link" href="contact.blade.php">Contact Us</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="one-page.blade.php">One Page</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="login-page.blade.php">Login</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="item item-1">
            <div class="img-fill">
                <div class="text-content">
                  ...
                  <h4>Legal Analysis<br>&amp; Consulting</h4>
                  ...
                  <a href="signup-page.blade.php" class="filled-button">SIGN UP</a>
                </div>
            </div>
          </div>
          <!-- // Item -->
          ...
          <div class="item item-2">
            <div class="img-fill">
                <div class="text-content">
                  ...
                  <a href="services.blade.php" class="filled-button">our services</a>
                </div>
            </div>
          </div>
          <!-- // Item -->
          ...
          <div class="item item-3">
            <div class="img-fill">
                <div class="text-content">
                  ...
                  <a href="about.blade.php" class="filled-button">learn more</a>
                </div>
            </div>
          </div>
          <!-- // Item -->
