...
<html lang="en">
  ...
  <head>
    ...
    <title>Legal Literacy - Services</title>
    ...
    <div class="single-services">
      <div class="container">
        <div class="row" id="tabs">
          <div class="col-md-4">
            <ul>
              <li><a href='#tabs-1'>Hukum Perdata <i class="fa fa-angle-right"></i></a></li>
              <li><a href='#tabs-2'>Hukum Pidana <i class="fa fa-angle-right"></i></a></li>
              <li><a href='#tabs-3'>Hukum Keluarga & Warisan <i class="fa fa-angle-right"></i></a></li>
